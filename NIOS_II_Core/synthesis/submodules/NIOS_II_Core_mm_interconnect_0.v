// NIOS_II_Core_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module NIOS_II_Core_mm_interconnect_0 (
		...
		input  wire [12:0] nios2_gen2_0_instruction_master_address,        //          nios2_gen2_0_instruction_master.address
	...
	wire  [87:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [87:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_memory2_0_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // onchip_memory2_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [13:0] pio_0_s1_agent_m0_address;                                                          // pio_0_s1_agent:m0_address -> pio_0_s1_translator:uav_address
	...
	wire  [87:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> pio_0_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // pio_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [87:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [87:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [87:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [87:0] cmd_demux_001_src1_data;                                                            // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [87:0] rsp_demux_001_src1_data;                                                            // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire         pio_0_s1_agent_rdata_fifo_src_valid;                                                // pio_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] pio_0_s1_agent_rdata_fifo_src_data;                                                 // pio_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         pio_0_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_002:in_0_ready -> pio_0_s1_agent:rdata_fifo_src_ready
	...
	NIOS_II_Core_mm_interconnect_0_router router (
	...
	NIOS_II_Core_mm_interconnect_0_router_001 router_001 (
	...
	NIOS_II_Core_mm_interconnect_0_router_002 router_002 (
	...
	NIOS_II_Core_mm_interconnect_0_router_002 router_003 (
	...
	NIOS_II_Core_mm_interconnect_0_router_004 router_004 (
	...
	NIOS_II_Core_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_II_Core_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
